...
return Quest.new({
    ...
    steps = {
        ...
        deliver(SADNESS, 'Crisp stack of papers', 1,
            'deliver the Crisp stack of papers to Sadness of Distant Mountains'),
        deliver(TESTING, "Sadness of Distant Mountains's rebuttal", 2,
            "deliver Sadness's rebuttal to Hammer Testing Strike"),
        deliver(LYDIA, "Hammer Testing Strike's retort", 3,
            'deliver the retort to Lydia Springstrong'),
        deliver(TEARING, "Lydia Springstrong's counterargument", 4,
            "deliver Lydia's counterargument to Hammer Tearing Strike"),
        deliver(SADNESS, "Hammer Tearing Strike's protest", 5,
            'deliver the protest to Sadness of Distant Mountains'),
        deliver(TEARING, "Sadness of Distant Mountains's grievance", 6,
            "deliver Sadness's grievance to Hammer Tearing Strike"),
        deliver(SADNESS, "Hammer Tearing Strike's challenge", 7,
            'deliver the challenge to Sadness of Distant Mountains'),
